...
class TKProgressBar(object):
    ...
    def __init__(self, root, max, length=400, width=DEFAULT_PROGRESS_BAR_SIZE[1], style=DEFAULT_PROGRESS_BAR_STYLE,
        ...
        if orientation[0].lower() == 'h':
            ...
            self.TKProgressBarForReal = tkinter.ttk.Progressbar(root, maximum=self.Max,
            ...
            self.TKProgressBarForReal = tkinter.ttk.Progressbar(root, maximum=self.Max,
                                                                style=str(length) + str(
                                                                    width) + 'my.Vertical.TProgressbar',
...
class QuickMeter(object):
    ...
    def __init__(self, title, current_value, max_value, key, *args, **_3to2kwargs):
        if 'grab_anywhere' in _3to2kwargs:
            grab_anywhere = _3to2kwargs['grab_anywhere']; del _3to2kwargs['grab_anywhere']
        else:
            grab_anywhere = False
        if 'border_width' in _3to2kwargs:
            border_width = _3to2kwargs['border_width']; del _3to2kwargs['border_width']
        else:
            border_width = None
        if 'size' in _3to2kwargs:
            size = _3to2kwargs['size']; del _3to2kwargs['size']
        else:
            size = DEFAULT_PROGRESS_BAR_SIZE
        if 'button_color' in _3to2kwargs:
            button_color = _3to2kwargs['button_color']; del _3to2kwargs['button_color']
        else:
            button_color = (None, None)
        if 'bar_color' in _3to2kwargs:
            bar_color = _3to2kwargs['bar_color']; del _3to2kwargs['bar_color']
        else:
            bar_color = (None, None)
        if 'orientation' in _3to2kwargs:
            orientation = _3to2kwargs['orientation']; del _3to2kwargs['orientation']
        else:
            orientation = 'v'
        """
...
class DebugWin(object):
    ...
    def Print(self, *args, **_3to2kwargs):
        if 'sep' in _3to2kwargs:
            sep = _3to2kwargs['sep']; del _3to2kwargs['sep']
        else:
            sep = None
        if 'end' in _3to2kwargs:
            end = _3to2kwargs['end']; del _3to2kwargs['end']
        else:
            end = None
        """
...
def EasyPrint(*args, **_3to2kwargs):
    if 'do_not_reroute_stdout' in _3to2kwargs:
        do_not_reroute_stdout = _3to2kwargs['do_not_reroute_stdout']; del _3to2kwargs['do_not_reroute_stdout']
    else:
        do_not_reroute_stdout = True
    if 'keep_on_top' in _3to2kwargs:
        keep_on_top = _3to2kwargs['keep_on_top']; del _3to2kwargs['keep_on_top']
    else:
        keep_on_top = False
    if 'grab_anywhere' in _3to2kwargs:
        grab_anywhere = _3to2kwargs['grab_anywhere']; del _3to2kwargs['grab_anywhere']
        ...
        grab_anywhere = False
    if 'no_button' in _3to2kwargs:
        no_button = _3to2kwargs['no_button']; del _3to2kwargs['no_button']
    else:
        no_button = False
    if 'no_titlebar' in _3to2kwargs:
        no_titlebar = _3to2kwargs['no_titlebar']; del _3to2kwargs['no_titlebar']
    else:
        no_titlebar = False
    if 'font' in _3to2kwargs:
        font = _3to2kwargs['font']; del _3to2kwargs['font']
    else:
        font = None
    if 'location' in _3to2kwargs:
        location = _3to2kwargs['location']; del _3to2kwargs['location']
    else:
        location = (None, None)
    if 'sep' in _3to2kwargs:
        sep = _3to2kwargs['sep']; del _3to2kwargs['sep']
...
def PopupScrolled(*args, **_3to2kwargs):
    if 'non_blocking' in _3to2kwargs:
        non_blocking = _3to2kwargs['non_blocking']; del _3to2kwargs['non_blocking']
    else:
        non_blocking = False
    ...
    if 'size' in _3to2kwargs:
        ...
        size = (None, None)
    if 'auto_close_duration' in _3to2kwargs:
        auto_close_duration = _3to2kwargs['auto_close_duration']; del _3to2kwargs['auto_close_duration']
    else:
        auto_close_duration = None
    if 'auto_close' in _3to2kwargs:
        auto_close = _3to2kwargs['auto_close']; del _3to2kwargs['auto_close']
    else:
        auto_close = False
    if 'yes_no' in _3to2kwargs:
        yes_no = _3to2kwargs['yes_no']; del _3to2kwargs['yes_no']
    else:
        yes_no = False
    if 'button_color' in _3to2kwargs:
        button_color = _3to2kwargs['button_color']; del _3to2kwargs['button_color']
...
def Popup(*args, **_3to2kwargs):
    ...
    if 'font' in _3to2kwargs:
        ...
        font = None
    if 'line_width' in _3to2kwargs:
        line_width = _3to2kwargs['line_width']; del _3to2kwargs['line_width']
    else:
        line_width = None
    if 'icon' in _3to2kwargs:
        icon = _3to2kwargs['icon']; del _3to2kwargs['icon']
    else:
    ...
    if 'non_blocking' in _3to2kwargs:
        ...
        non_blocking = False
    if 'custom_text' in _3to2kwargs:
        custom_text = _3to2kwargs['custom_text']; del _3to2kwargs['custom_text']
    else:
    ...
    if 'auto_close' in _3to2kwargs:
        ...
        auto_close = False
    if 'button_type' in _3to2kwargs:
        button_type = _3to2kwargs['button_type']; del _3to2kwargs['button_type']
    else:
        button_type = POPUP_BUTTONS_OK
    if 'text_color' in _3to2kwargs:
        text_color = _3to2kwargs['text_color']; del _3to2kwargs['text_color']
    else:
        text_color = None
    if 'background_color' in _3to2kwargs:
        background_color = _3to2kwargs['background_color']; del _3to2kwargs['background_color']
    else:
    ...
    def _build_main_debugger_window(self, location=(None, None)):
        ...
        for i in range(NUM_AUTO_WATCH):
            var_layout.append([T('', size=(WIDTH_WATCHER_VARIABLES, 1), key='_WATCH%s_' % i),
                               T('', size=(WIDTH_WATCHER_RESULTS, MAX_LINES_PER_RESULT_MAIN),
    ...
    def _refresh_main_debugger_window(self, mylocals, myglobals):
        ...
        for key in self.local_choices:
            ...
            if self.local_choices[key]:
                ...
                try:
                    self.watcher_window.Element('_WATCH{}_RESULT_'.format(slot), silent_on_error=True).Update(
                        mylocals[key])
                except:
    ...
    def _choose_auto_watches(self, my_locals):
        ...
        layout += [
            [Text('Custom Watch (any expression)'),
             Input(default_text=self.custom_watch, size=(40, 1), key='_CUSTOM_WATCH_')]]
        layout += [
